...
1. ```cd ~/Desktop && mkdir -p ~/Desktop 116117suche && cd ~/Desktop/116117suche && curl -O https://raw.githubusercontent.com/tresitresen/116117-suche/main/116117_parser_html.py```
...
3. ```pbpaste > ~/Desktop/116117suche/ergebnisse.html```
4. (```pip install beautifulsoup4```)
4. ```python3 116117_parser_html.py```
